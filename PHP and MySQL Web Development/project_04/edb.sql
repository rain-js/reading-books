...
--where ea01.a01001 = 'e171101170743'
where ea01.a01001 = 'e161231092118'
	and ei05.i05003 = '左手'
	
	
-----------------------------------
-----SQL Server (link server query)
-----------------------------------
select * from openquery(EDB, 'select ea01.a01001 as "编号",
	ea01.a01027 as "体检号",
	ei03.i03005 as "面色",
	ei03.i03003 as "光泽",
	ei03.i03004 as "唇色",
